            ...
            dbc.Container([
                ...
                dbc.Row([dbc.Col([
                    dbc.Input(id="select-image-file-path",
                              ...
                              placeholder='Please enter the absolute file '
                                          'path!')],
                )], style={"padding": "25px"}),
            ], id="select-electrode-grid-bg"),
            dbc.Row([
                dbc.Col([
                    html.Img(src="/assets/xkcd.png",
                             id="select-mea-setup-img")],
                ...
                style={"padding": "25px"}),
            dbc.Row([
                dbc.Col([html.H6("Specify a time range for analysis "
                                 "(s:ms:mus): ")],
                        width="auto"),
                dbc.Col([
                    dbc.Input(placeholder="Start time (s:ms:mus)",
                              id="select-start"),
                    ], width="auto"),
                dbc.Col([
                    dbc.Input(placeholder="Stop time (s:ms:mus)",
                              id="select-stop")
                    ], width="auto")
            ],
                id="select-time",
